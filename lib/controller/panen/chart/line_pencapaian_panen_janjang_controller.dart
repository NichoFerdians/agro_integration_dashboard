...
class LinePencapaianPanenJanjangController extends GetxController {
  static LinePencapaianPanenJanjangController get to => Get.find();
  ...
  void onInit() {
    ...
    Map<String, dynamic> chart = {
      "caption": "Trend Produksi Day-to-Day (Janjang)",
      "xaxisname": "",
      "yaxisname": "",
      "theme": "fusion",
      "drawcrossline": "1"
